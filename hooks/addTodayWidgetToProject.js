...
module.exports = function (context) {
    ...
    var PROVISIONING_PROFILE_UUID = getCordovaParameter("PROVISIONING_PROFILE_UUID", contents);
    ...
    fs.readdir(iosFolder, function (err, data) {
        ...
        var run = function () {
            ...
            log('>>>>>>>>>' + projectPlistJson['CFBundleDisplayName'], 'info')
            log('>>>>>>>>>' + projectPlistJson['BundleDisplayName'], 'info')
            log('>>>>>>>>>' + projectPlistJson['CFBundleIdentifier'], 'info')
            log('>>>>>>>>>' + projectPlistJson['BundleIdentifier'], 'info')
            log('>>>>>>>>>' + projectPlistJson, 'info')
            ...
            // Add a new PBXFrameworksBuildPhase for the Frameworks used by the Shortcut (Intents.framework, libCordova.a)
            ...
            // Add the frameworks needed by our Shortcut, add them to the existing Frameworks PbxGroup and PBXFrameworksBuildPhase
                    ...
                    if (typeof buildSettingsObj['PRODUCT_NAME'] !== 'undefined') {
                        ...
                        if (productName.indexOf('Shortcuts') >= 0) {
                            ...
                            if (addEntitlementsFile) {
                                ...
                                buildSettingsObj['PROVISIONING_PROFILE'] = PROVISIONING_PROFILE_UUID;
                                ...
                                log('Added PROVISIONING_PROFILE  ' + PROVISIONING_PROFILE_UUID, 'info');
                            }
